...
| :--- | :--- | :--- | :--- | :--- |
| **AVIRIS / AVIRIS-NG** | NASA JPL | 224 bands ($380-2510\text{nm}$) | $4\text{m} - 20\text{m}$ airborne | [aviris.jpl.nasa.gov](https://aviris.jpl.nasa.gov/) |
| **EO-1 Hyperion** | NASA / USGS | 242 bands ($357-2576\text{nm}$) | $30\text{m}$ spaceborne | [earthexplorer.usgs.gov](https://earthexplorer.usgs.gov/) |
| **PRISMA** | ASI (Italian Space Agency) | 240 bands ($400-2500\text{nm}$) | $30\text{m}$ spaceborne | [prisma.asi.it](https://prisma.asi.it/) |
| **EnMAP** | DLR (German Aerospace) | 224 bands ($420-2450\text{nm}$) | $30\text{m}$ spaceborne | [enmap.org](https://www.enmap.org/) |
| **Indian HySI** | ISRO | 64 bands ($400-950\text{nm}$) | $500\text{m}$ spaceborne | [bhuvan.nrsc.gov.in](https://bhuvan.nrsc.gov.in/) |
